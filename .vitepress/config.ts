      ...
      themeConfig: {
        sidebar: [
          { text: 'Erste Schritte', link: '/de/index' },
          {
            ...
            collapsed: false,
            items: [
              { text: 'Hier starten', link: '/de/application-manual/elements' },
              { text: 'Event erstellen', link: '/de/application-manual/create-event' },
              { text: 'Events verwalten', link: '/de/application-manual/groups-and-events' },
              { text: 'Event teilen', link: '/de/application-manual/sharing-events' },
              { text: 'Kalender-Abonnements', link: '/de/application-manual/calendar-subscriptions' },
              { text: 'Öffentliche Event-Liste', link: '/de/application-manual/event-list' },
              { text: 'Styles und Templates', link: '/de/application-manual/styles-and-templates' },
              { text: 'RSVP-Formulare', link: '/de/application-manual/rsvp-forms' },
              { text: 'RSVP-Antworten', link: '/de/application-manual/managing-rsvp' },
              { text: 'RSVP-E-Mails', link: '/de/application-manual/email-templates' },
              { text: 'Landingpages', link: '/de/application-manual/landing-pages' },
              { text: 'Call-to-Action', link: '/de/application-manual/cta-templates' },
          ...
          },
          {
            ...
            items: [
              ...
              { text: 'Event-Übersichts-Seite', link: '/de/recipes/event-list' },
          ...
          },
          {
            ...
            items: [
              ...
              { text: 'Event-Liste', link: '/de/integration/event-list' },
              ...
              { text: 'Nuxt', link: '/de/integration/nuxt' },
  ...
  themeConfig: {
    ...
    sidebar: [
      { text: 'Getting started', link: '/index' },
      {
        ...
        collapsed: false,
        items: [
          { text: 'Start Here', link: '/application-manual/elements' },
          { text: 'Create an Event', link: '/application-manual/create-event' },
          { text: 'Organize Events', link: '/application-manual/groups-and-events' },
          { text: 'Share an Event', link: '/application-manual/sharing-events' },
          { text: 'Calendar Subscriptions', link: '/application-manual/calendar-subscriptions' },
          { text: 'Public Event List', link: '/application-manual/event-list' },
          { text: 'Styles and Templates', link: '/application-manual/styles-and-templates' },
          { text: 'RSVP Forms', link: '/application-manual/rsvp-forms' },
          { text: 'RSVP Responses', link: '/application-manual/managing-rsvp' },
          { text: 'RSVP Emails', link: '/application-manual/email-templates' },
          { text: 'Landing Pages', link: '/application-manual/landing-pages' },
          { text: 'Calls to Action', link: '/application-manual/cta-templates' },
      ...
      },
      {
        ...
        items: [
          ...
          { text: 'Event Overview List', link: '/recipes/event-list' },
      ...
      },
      {
        ...
        items: [
          ...
          { text: 'Event List', link: '/integration/event-list' },
